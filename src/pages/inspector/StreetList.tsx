...
export default function StreetList() {
  ...
  const allDone = streets && streets.length > 0 && streets.every((s) => s.complete === s.total && s.total > 0);
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-right">
                  <span className={`text-sm font-semibold ${isDone ? "text-green-600" : "text-gray-500"}`}>
